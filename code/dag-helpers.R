#  program:  dag-helpers.R
#  task:     DAG-drawing helpers, vendored from Richard McElreath's
#            `rethinking` package (the Statistical Rethinking book
#            package)
#  source:   https://github.com/rmcelreath/rethinking/blob/master/R/drawdag.R
#            commit as of 2026-09-02. Author: Richard McElreath.
#            License: GPL (>= 3), per rethinking's DESCRIPTION -- kept
#            verbatim below except for this header; not modified.
#  project:  RoR
#  author:   sam harper \ 2026-09-02
