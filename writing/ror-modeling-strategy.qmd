...
tab |>
  # Truth is only meaningful for the fixed effects -- this table's job is
  # to show fixed-effect recovery, not the random-effect SDs (which are
  # genuinely 0 by construction for this model and just invite the
  # "why doesn't the estimate show exactly 0" question without adding to
  # the table's actual point)
